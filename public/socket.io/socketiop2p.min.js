    ...
    return function n(e, t, r) {
        ...
        2: [function(e, t, r) {
            ...
            function f(e, t, r) {
                ...
                if (n === "number") {
                    ...
                    if (e.type === "Buffer" && o(e.data)) e = e.data;
                    i = +e.length
                } else {
                ...
                if (f.TYPED_ARRAY_SUPPORT && typeof e.byteLength === "number") {
                    ...
                    if (f.isBuffer(e)) {
                        for (u = 0; u < i; u++) c[u] = e.readUInt8(u)
                    } else {
                        for (u = 0; u < i; u++) c[u] = (e[u] % 256 + 256) % 256
                    }
                } else if (n === "string") {
                    c.write(e, 0, t)
                ...
                if (i > 0 && i <= f.poolSize) c.parent = s;
                return c
            }
            ...
            f.compare = function(e, t) {
                ...
                var r = e.length;
                var n = t.length;
                for (var i = 0, o = Math.min(r, n); i < o && e[i] === t[i]; i++) {}
                if (i !== o) {
                    r = e[i];
                    n = t[i]
                }
            ...
            f.prototype.write = function(e, t, r, n) {
                ...
                t = Number(t) || 0;
                if (r < 0 || t < 0 || t > this.length) throw new RangeError("attempt to write outside buffer bounds");
                var o = this.length - t;
                if (!r) {
                    r = o
                } else {
            ...
            f.prototype.readUInt8 = function(e, t) {
                if (!t) E(e, 1, this.length);
                return this[e]
            };
            f.prototype.readUInt16LE = function(e, t) {
                if (!t) E(e, 2, this.length);
            ...
            f.prototype.writeUIntLE = function(e, t, r, n) {
                ...
                t = t >>> 0;
                r = r >>> 0;
                if (!n) A(this, e, t, r, Math.pow(2, 8 * r), 0);
                var i = 1;
                var o = 0;
                this[t] = e & 255;
                while (++o < r && (i *= 256)) this[t + o] = e / i >>> 0 & 255;
                return t + r
            };
            f.prototype.writeUIntBE = function(e, t, r, n) {
                ...
                var o = 1;
                this[t + i] = e & 255;
                while (--i >= 0 && (o *= 256)) this[t + i] = e / o >>> 0 & 255;
                return t + r
            };
            f.prototype.writeUInt8 = function(e, t, r) {
                e = +e;
                t = t >>> 0;
                if (!r) A(this, e, t, 1, 255, 0);
            ...
            f.prototype.writeUInt16LE = function(e, t, r) {
                e = +e;
                t = t >>> 0;
                if (!r) A(this, e, t, 2, 65535, 0);
                if (f.TYPED_ARRAY_SUPPORT) {
                    this[t] = e;
                    this[t + 1] = e >>> 8
                } else C(this, e, t, true);
                return t + 2
            };
            ...
            f.prototype.writeUInt32LE = function(e, t, r) {
                e = +e;
                t = t >>> 0;
                if (!r) A(this, e, t, 4, 4294967295, 0);
                if (f.TYPED_ARRAY_SUPPORT) {
                    this[t + 3] = e >>> 24;
                    this[t + 2] = e >>> 16;
                    this[t + 1] = e >>> 8;
                    this[t] = e
                } else k(this, e, t, true);
                return t + 4
            };
            ...
            f.prototype.writeIntLE = function(e, t, r, n) {
                ...
                var a = e < 0 ? 1 : 0;
                this[t] = e & 255;
                while (++i < r && (o *= 256)) this[t + i] = (e / o >> 0) - a & 255;
                return t + r
            };
            f.prototype.writeIntBE = function(e, t, r, n) {
                ...
                var a = e < 0 ? 1 : 0;
                this[t + i] = e & 255;
                while (--i >= 0 && (o *= 256)) this[t + i] = (e / o >> 0) - a & 255;
                return t + r
            };
            f.prototype.writeInt8 = function(e, t, r) {
                e = +e;
                t = t >>> 0;
                if (!r) A(this, e, t, 1, 127, -128);
                if (!f.TYPED_ARRAY_SUPPORT) e = Math.floor(e);
                if (e < 0) e = 255 + e + 1;
                this[t] = e;
                return t + 1
            ...
            f.prototype.writeInt32LE = function(e, t, r) {
                e = +e;
                t = t >>> 0;
                if (!r) A(this, e, t, 4, 2147483647, -2147483648);
                if (f.TYPED_ARRAY_SUPPORT) {
                    this[t] = e;
                    this[t + 1] = e >>> 8;
                    this[t + 2] = e >>> 16;
            ...
            function R(e, t, r, n, o) {
                if (!o) S(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38);
            ...
            function T(e, t, r, n, o) {
                if (!o) S(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308);
            ...
            f.prototype.copy = function(e, t, r, n) {
                ...
                if (r < 0 || r >= i.length) throw new RangeError("sourceStart out of bounds");
                if (n < 0) throw new RangeError("sourceEnd out of bounds");
                if (n > this.length) n = this.length;
                if (e.length - t < n - r) n = e.length - t + r;
                var o = n - r;
        ...
        3: [function(e, t, r) {
            ...
            (function(e) {
                ...
                function u(e) {
                    ...
                    if (t === i || t === c) return 63;
                    if (t < o) return -1;
                    if (t < o + 10) return t - o + 26 + 26;
                    if (t < s + 26) return t - s;
                    if (t < a + 26) return t - a + 26
                }
                ...
                if (i(r)) {
                    switch (arguments.length) {
                        ...
                        default:
                            n = arguments.length;
                            o = new Array(n - 1);
                            for (f = 1; f < n; f++) o[f - 1] = arguments[f];
                            r.apply(this, o)
                    }
                } else if (a(r)) {
                    n = arguments.length;
                    ...
                    c = r.slice();
                    n = c.length;
                    for (f = 0; f < n; f++) c[f].apply(this, o)
                }
                return true
            };
        ...
        11: [function(e, t, r) {
            (function(r) {
                ...
                c(n(a.prototype), function(e) {
                    if (!s.prototype[e]) s.prototype[e] = a.prototype[e]
                });
        ...
        13: [function(e, t, r) {
            (function(r) {
                ...
                if (!o.listenerCount) o.listenerCount = function(e, t) {
                ...
                l.prototype.read = function(e) {
                    ...
                    if (e === 0 && t.needReadable && (t.length >= t.highWaterMark || t.ended)) {
                        ...
                        if (t.length === 0 && t.ended) T(this);
                        else m(this);
                        return null
                    }
                    e = v(e, t);
                    if (e === 0 && t.ended) {
                        if (t.length === 0) T(this);
                        return null
                    }
                    ...
                    if (r !== e && t.ended && t.length === 0) T(this);
                ...
                l.prototype.pipe = function(e, t) {
                    ...
                    function d() {
                        ...
                        if (a.awaitDrain && (!e._writableState || e._writableState.needDrain)) h()
                    }
                    i.on("data", p);
                    ...
                    function g(t) {
                        ...
                        y();
                        e.removeListener("error", g);
                        if (o.listenerCount(e, "error") === 0) e.emit("error", t)
                    }
                ...
                function R(e, t) {
                    ...
                    if (n === 0) s = null;
                        ...
                        if (e < r[0].length) {
                            ...
                            var c = 0;
                            for (var u = 0, l = r.length; u < l && c < e; u++) {
                                var f = r[0];
        ...
        15: [function(e, t, r) {
            (function(r) {
                ...
                f.prototype.uncork = function() {
                    ...
                    if (e.corked) {
                        e.corked--;
                        if (!e.writing && !e.corked && !e.finished && !e.bufferProcessing && e.buffer.length) m(this, e)
                    }
                };
                ...
                function h(e, t, r, n, o) {
                    ...
                    if (t.writing || t.corked) t.buffer.push(new a(r, n, o));
                    else d(e, t, false, s, r, n, o);
                    return f
                }
        ...
        40: [function(e, t, r) {
            ...
            function d(e) {
                ...
                if (null == r.types[t.type]) return g();
                if (r.BINARY_EVENT == t.type || r.BINARY_ACK == t.type) {
                    t.attachments = "";
                    while (e.charAt(++o) != "-") {
        ...
        43: [function(e, t, r) {
            ...
            function n(e) {
                if (!n.enabled(e)) return function() {};
                return function(t) {
                    t = i(t);
                    var r = new Date;
                    var o = r - (n[e] || r);
            ...
            n.humanize = function(e) {
                var t = 1e3,
                    r = 60 * 1e3,
                    n = 60 * r;
                if (e >= n) return (e / n).toFixed(1) + "h";
                if (e >= r) return (e / r).toFixed(1) + "m";
            ...
            try {
                if (window.localStorage) n.enable(localStorage.debug)
            } catch (o) {}
        }, {}],
        44: [function(e, t, r) {
            arguments[4][8][0].apply(r, arguments)
                ...
                if (!h("json")) {
                    ...
                    if (!h("json-stringify")) {
                        ...
                        var L = function(e, t, n, s, f, c, u) {
                            var l, h, d, m, _, A, C, k, S, T, B, M, P, x, j, U;
                            try {
                                l = t[e]
                            } catch (N) {}
                        ...
                        c.stringify = function(e, t, n) {
                            ...
                            if (typeof t == "function" || typeof t == "object" && t) {
                                if ((s = r.call(t)) == d) {
                                    ...
                                    a = {};
                                    for (var f = 0, c = t.length, u; f < c; u = t[f++], (s = r.call(u), s == v || s == g) && (a[u] = 1));
                                }
                            }
                            if (n) {
                                if ((s = r.call(n)) == g) {
            ...
            function p(e, t, r) {
                ...
                i.on("peer_ready", function(e) {
                    ...
                    if (i.readyPeers >= i.numConnectedClients && !i.ready) {
                        i.ready = true;
                        if (i.opts.autoUpgrade) i.usePeerConnection = true;
                        if (typeof i.cb === "function") i.cb();
                        i.emit("upgrade")
                    }
                })
            }
